#!/bin/bash
# -------------------------------------------------------------------------------
# Filename:    mixed_case.sh
# Revision:    1.0
# Date:        2018/09/18
# Author:      yangyang
# Email:       yangyang@xsky.com
# Description: Mixed exception script
# Notes:       This script executes a single exception or multiple random select exceptions
# -------------------------------------------------------------------------------
...
rand_case()
{
	array=(down_public stop_mon disk_abnormal stop_osd down_cluster stop_xdc  public_flashing kill_mon  cluster_flashing kill_osd kill_osds kill_xdc kill_etcd kill_etcd_proxy)
	#echo "array is $array"
...
{
	echo ""
	echo -e "\033[33m You need to specify the network card before executing the script!!! \033[0m"
	...
	echo -e "\033[33m rand 		-- Run one at random in the use case \033[0m"
	echo ""
